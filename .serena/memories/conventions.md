...
- For next-character comparisons, separate baseRepresentation from enhancementLayer, conformance from evaluation, and observable measurement error from representation failure.
- Paid/cloud use requires mi3san's proactive instruction or explicit approval of a concrete proposal; silence and earlier approval are not reusable authorization.
