...
import { BINARY_SHA256, P0_LOCAL_FONT_SHA256, P0_LOCAL_FONT_SOURCE_OVERRIDES, TRACKED_TEXT_BLOBS, reviewStatus } from "./contracts";
...
describe("P0 contracts", () => {
  ...
  it("permits only the approved local font assets and loader source overrides", () => {
    ...
    expect(P0_LOCAL_FONT_SOURCE_OVERRIDES).toEqual(["src/components/ChalkBoard.tsx", "src/components/KaraokeSubtitle.tsx"]);
  });
