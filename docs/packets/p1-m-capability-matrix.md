...
| owner 判断 | **決定6（K-02 人時計上）** — これが無いとコスト軸が組めない |
...
| 制作コスト | effort log。**決定6 が未決なら「未確定」と表示する** |
...
| コスト軸が決定6 未決のまま数値で埋まっている | 捏造の検出 |

## STOP 条件

- **決定6（K-02）が未決。** コスト軸を推測値で埋めない。「未確定」と表示して報告する
